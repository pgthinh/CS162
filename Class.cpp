...
/*void getstudents(string classname){
    clrscr(); //heading();
    cout << "\n\n\t\t\t\t\t\t   ";
                ...
                switch (select){
                    ...
                    case 3:{
                        ...
                        while(student_cur){
                            ...
                            while (j != 5){
                                if (courseList){
                                    gotoxy(47 + j * 8, 14 + i * 3); cout << courseList->CourseID;
                                    gotoxy(47 + j * 8, 15 + i * 3); cout << fixed << markList->totalMark;
                                    courseList = courseList->next_Course;
                                    markList = markList->next_Mark;
                                }
                                else {
